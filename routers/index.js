...
// 添加用户
router.post('/manager/user/add', (req, res) => {
  // 读取请求参数数据
  const {username, password} = req.body
...
// 更新用户
router.post('/manager/user/update', (req, res) => {
  const user = req.body
...
// 删除用户
router.post('/manager/user/delete', (req, res) => {
...
// 获取所有用户列表
router.get('/manager/user/list', (req, res) => {
...
// 添加分类
router.post('/manager/category/add', (req, res) => {
...
// 获取分类列表
router.get('/manager/category/list', (req, res) => {
  console.log('后台初始化：',req.query.parentId);
  const parentId = req.query.parentId || '0'
  CategoryModel.find({parentId})
    .then(categorys => {
      res.send({status: 0, data: categorys})
      console.log('后台then()：',categorys)
    })
...
// 更新分类名称
router.post('/manager/category/update', (req, res) => {
...
// 根据分类ID获取分类
router.get('/manager/category/info', (req, res) => {
...
// 添加产品
router.post('/manager/product/add', (req, res) => {
...
// 获取产品分页列表
router.get('/manager/product/list', (req, res) => {
...
// 搜索产品列表
router.get('/manager/product/search', (req, res) => {
...
// 更新产品
router.post('/manager/product/update', (req, res) => {
  const product = req.body
...
// 更新产品状态(上架/下架)
router.post('/manager/product/updateStatus', (req, res) => {
...
// 添加角色
router.post('/manager/role/add', (req, res) => {
...
// 获取角色列表
router.get('/manager/role/list', (req, res) => {
  RoleModel.find()
    .then(roles => {
...
// 更新角色(设置权限)
router.post('/manager/role/update', (req, res) => {
  const role = req.body
